        ...
        <div className="bg-gray-800/80 backdrop-blur-md rounded-2xl border border-white/10 p-8">
          {!result ? (
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="text-center"><button type="submit" className="bg-gradient-to-r from-purple-500 to-gray-500 hover:from-purple-600 hover:to-gray-600 text-white font-black py-4 px-8 rounded-xl transition-all shadow-xl hover:shadow-purple-500/30 text-lg">{lang === 'hi' ? 'नक्षत्र खोजें' : 'Find Nakshatra'}</button></div>
            </form>
          ) : (
