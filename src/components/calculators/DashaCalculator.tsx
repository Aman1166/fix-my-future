        ...
        <div className="glass-heavy rounded-2xl border border-[var(--border-color)] p-8">
          {!result ? (
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="text-center"><button type="submit" className="bg-gradient-to-r from-purple-500 to-gray-500 hover:from-purple-600 hover:to-gray-600 text-[var(--text-primary)] font-black py-4 px-8 rounded-xl transition-all shadow-xl hover:shadow-purple-500/30 text-lg">{lang === 'hi' ? 'दशा कैल्कुलेट करें' : 'Calculate Dasha'}</button></div>
            </form>
          ) : (
