          ...
          <div className="bg-gray-800/80 backdrop-blur-md rounded-2xl border border-white/10 p-8">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                <h4 className="text-amber-500 font-bold text-xl text-center mb-4">
          ...
          <div className="bg-gray-800/80 backdrop-blur-md rounded-2xl border border-white/10 p-8">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-6">
              <div className="bg-gray-700/50 rounded-xl p-6">
                <h4 className="text-amber-500 font-bold text-lg mb-4 text-center">
                  {lang === 'hi' ? 'लड़के की जानकारी' : 'Boy\'s Information'}
                </h4>
                <div className="text-gray-300 space-y-2">
                  <div><span className="font-bold text-white">{lang === 'hi' ? 'नाम:' : 'Name:'}</span> {formData.boyName}</div>
                  <div><span className="font-bold text-white">{lang === 'hi' ? 'जन्म तिथि:' : 'Birth Date:'}</span> {formData.boyBirthDate}</div>
                  <div><span className="font-bold text-white">{lang === 'hi' ? 'जन्म समय:' : 'Birth Time:'}</span> {formData.boyBirthTime}</div>
                  <div><span className="font-bold text-white">{lang === 'hi' ? 'जन्म स्थान:' : 'Birth Place:'}</span> {formData.boyBirthPlace}</div>
                </div>
              </div>
              ...
              <div className="bg-gray-700/50 rounded-xl p-6">
                ...
                <div className="text-gray-300 space-y-2">
                  <div><span className="font-bold text-white">{lang === 'hi' ? 'नाम:' : 'Name:'}</span> {formData.girlName}</div>
                  <div><span className="font-bold text-white">{lang === 'hi' ? 'जन्म तिथि:' : 'Birth Date:'}</span> {formData.girlBirthDate}</div>
                  <div><span className="font-bold text-white">{lang === 'hi' ? 'जन्म समय:' : 'Birth Time:'}</span> {formData.girlBirthTime}</div>
                  <div><span className="font-bold text-white">{lang === 'hi' ? 'जन्म स्थान:' : 'Birth Place:'}</span> {formData.girlBirthPlace}</div>
                </div>
              </div>
            </div>
