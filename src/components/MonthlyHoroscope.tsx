    ...
    <div className="fixed inset-0 z-[64] overflow-y-auto bg-gray-800">
      ...
      <div className="relative h-[32vh] md:h-[40vh] overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
          ...
          <h1 className="text-4xl md:text-6xl font-black text-white mb-3 tracking-tight drop-shadow-xl animate-slideInUp">{lang === 'hi' ? 'मासिक राशिफल' : 'Monthly Horoscope'}</h1>
