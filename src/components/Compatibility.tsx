...
export default function Compatibility({
  ...
  const zodiacSigns = [
    { name: 'Aries', hiName: 'मेष', symbol: '♈', dates: 'Mar 21 - Apr 19', color: 'from-red-500 to-amber-600-500' },
    ...
    { name: 'Cancer', hiName: 'कर्क', symbol: '♋', dates: 'Jun 22 - Jul 22', color: 'from-blue-400 to-amber-600-500' },
    { name: 'Leo', hiName: 'सिंह', symbol: '♌', dates: 'Jul 23 - Aug 22', color: 'from-amber-600-500 to-yellow-500' },
    ...
    { name: 'Aquarius', hiName: 'कुंभ', symbol: '♒', dates: 'Jan 20 - Feb 18', color: 'from-amber-600-500 to-blue-500' },
        ...
        {showResult && (
          <div className="glass-heavy rounded-2xl border border-[var(--border-color)] p-8 mb-8">
            ...
            <div className="glass rounded-xl p-6 text-center">
              ...
              <div className="text-6xl font-black text-green-400 mb-4">78%</div>
