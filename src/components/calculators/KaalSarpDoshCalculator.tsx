        ...
        <div className="glass-heavy rounded-2xl border border-[var(--border-color)] p-8">
          {!result ? (
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="text-center"><button type="submit" className="bg-gradient-to-r from-red-500 to-amber-600-500 hover:from-red-600 hover:to-amber-600-600 text-[var(--text-primary)] font-black py-4 px-8 rounded-xl transition-all shadow-xl hover:shadow-red-500/30 text-lg">{lang === 'hi' ? 'काल सर्प दोष जांचें' : 'Check Kaal Sarp Dosh'}</button></div>
            </form>
          ) : (
