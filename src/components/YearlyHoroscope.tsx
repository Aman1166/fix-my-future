...
export default function YearlyHoroscope({ isOpen, onClose }: { isOpen: boolean; onClose: () => void; }) {
  ...
  const getHoroscopeData = (_signName: string) => {
    // Sample yearly horoscope data
    return {
      love: "2026 brings transformative changes in your love life. Existing relationships deepen while singles find meaningful connections. Focus on emotional authenticity and mutual growth for lasting happiness.",
      personal: "This year emphasizes personal mastery and self-realization. Embrace change, learn new skills, and pursue passions that align with your true purpose. Spiritual growth brings inner peace.",
      career: "Professional success is written in your stars. Leadership opportunities arise, and your innovative ideas gain recognition. Financial stability improves through strategic decisions and hard work.",
      health: "Holistic wellness is crucial this year. Maintain balance between physical health, mental well-being, and spiritual practices. Regular check-ups and healthy lifestyle choices prevent issues.",
      emotions: "Emotional maturity reaches new heights. You develop greater empathy and understanding. This year teaches valuable lessons about forgiveness, compassion, and inner strength.",
      lucky: "Lucky numbers: 1, 4, 7, 13, 22. Lucky colors: Gold, Purple, White. Lucky gemstones: Diamond, Ruby. Lucky months: March, July, November. Best investment periods: Q2 and Q4.",
      travel: "International travel brings growth and new perspectives. Consider educational or spiritual journeys. Domestic travel provides relaxation and family bonding opportunities.",
      remedies: "Establish a daily spiritual practice. Wear gold jewelry regularly. Plant a sacred tree or maintain a home altar. Practice charity and selfless service. Chant your ruling planet's mantra daily."
    };
  };
    ...
    <div className="fixed inset-0 z-[64] overflow-y-auto bg-[var(--primary-bg)]">
      ...
      <div className="relative h-[32vh] md:h-[40vh] overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
          ...
          <h1 className="text-4xl md:text-6xl font-black text-[var(--text-primary)] mb-3 tracking-tight drop-shadow-xl animate-slideInUp">{lang === 'hi' ? 'वार्षिक राशिफल' : 'Yearly Horoscope'}</h1>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-[var(--text-secondary)]">
                    {lang === 'hi' ? 'वार्षिक राशिफल' : 'Yearly Horoscope'} - 2026
                  </p>
                </div>
              </div>
              <button
