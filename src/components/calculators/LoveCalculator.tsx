          ...
          {!result ? (
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="text-center">
                <button
                  type="submit"
                  className="bg-gradient-to-r from-pink-500 to-red-500 hover:from-pink-600 hover:to-red-600 text-[var(--text-primary)] font-black py-4 px-8 rounded-xl transition-all shadow-xl hover:shadow-pink-500/30 text-lg"
                >
            ...
            <div className="text-center">
              <div className="glass rounded-xl p-8 mb-6">
                ...
                <div className="bg-gradient-to-r from-pink-500/20 to-red-500/20 rounded-lg p-4 border border-pink-500/30">
