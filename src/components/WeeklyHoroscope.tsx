...
export default function WeeklyHoroscope({ isOpen, onClose }: { isOpen: boolean; onClose: () => void; }) {
  ...
  const getHoroscopeData = (_signName: string) => {
    // Sample weekly horoscope data
    return {
      love: "This week brings opportunities for deeper emotional connections. Focus on quality time with loved ones and express your feelings openly. New romantic possibilities may emerge mid-week.",
      personal: "Personal growth takes center stage this week. Reflect on your life goals and take concrete steps toward self-improvement. Consider starting new healthy habits or hobbies.",
      career: "Professional growth is indicated this week. Network with colleagues and superiors. Your innovative ideas will be valued. Consider taking on new responsibilities.",
      health: "Pay attention to your physical and mental well-being. Incorporate regular exercise into your routine. Focus on stress management techniques like meditation or yoga.",
      emotions: "Emotional balance will be your strength this week. Trust your intuition in decision-making. Practice gratitude daily to maintain positive energy.",
      lucky: "Lucky numbers: 5, 8, 15. Lucky color: Blue. Lucky day for career advancement. Lucky stone: Blue Sapphire for protection and success.",
      travel: "Travel opportunities arise mid-week. Business or personal trips will be successful. Consider short getaways for relaxation. Avoid long-distance travel on Wednesday.",
      remedies: "Perform daily meditation for 15 minutes. Wear blue colored clothing on Thursdays. Keep a blue sapphire or amethyst crystal with you. Chant 'Om' 108 times daily."
    };
  };
    ...
    <div className="fixed inset-0 z-[64] overflow-y-auto bg-[var(--primary-bg)]">
      ...
      <div className="relative h-[32vh] md:h-[40vh] overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
          ...
          <h1 className="text-4xl md:text-6xl font-black text-[var(--text-primary)] mb-3 tracking-tight drop-shadow-xl animate-slideInUp">{lang === 'hi' ? 'साप्ताहिक राशिफल' : 'Weekly Horoscope'}</h1>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-[var(--text-secondary)]">
                    {lang === 'hi' ? 'साप्ताहिक राशिफल' : 'Weekly Horoscope'} - {new Date().toLocaleDateString()} to {new Date(Date.now() + 7 * 24 * 60 * 60 * 1000).toLocaleDateString()}
                  </p>
                </div>
              </div>
              <button
